...
training_set <- read.table(file = 'H:/Career/Programming & Data Science/R/Coursera/UCI HAR Dataset/train/X_train.txt')
training_labels <- read.table(file = 'H:/Career/Programming & Data Science/R/Coursera/UCI HAR Dataset/train/y_train.txt')
subject_train <- read.table(file = 'H:/Career/Programming & Data Science/R/Coursera/UCI HAR Dataset/train/subject_train.txt')
test_set <- read.table(file = 'H:/Career/Programming & Data Science/R/Coursera/UCI HAR Dataset/test/X_test.txt')
test_labels <- read.table(file = 'H:/Career/Programming & Data Science/R/Coursera/UCI HAR Dataset/test/y_test.txt')
subject_test <- read.table(file = 'H:/Career/Programming & Data Science/R/Coursera/UCI HAR Dataset/test/subject_test.txt')
features <- read.table(file = 'H:/Career/Programming & Data Science/R/Coursera/UCI HAR Dataset/features.txt')
...
grouped_mean <- group_by(data_set, subject, activity) %>%
    summarise_all(mean)
write.table(grouped_mean, file = 'H:/Career/Programming & Data Science/R/Coursera/UCI HAR Dataset/Week4.txt', row.name = FALSE)
